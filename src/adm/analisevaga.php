...
// Montar query base para Pendentes
$sqlBase = "FROM vaga WHERE status='pendente'";
$params = [];
if (!empty($busca)) {
...
<div class="row">
    <div class="col-12">
        <form method="GET" action="analisevaga.php">
            <div class="card shadow-sm border-0">
                <div class="card-header text-white" style="background-color: #34495e;">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-clock mr-2"></i> Vagas Pendentes de Aprovação</h6>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table id="vagaspendentes" class="table table-sm table-hover table-striped mb-0" style="width:100%">
                          <thead style="background-color: #f8f9fc;">
                            ...
                            <tr>
                              ...
                              <th class="text-right pr-4 pb-3 border-top-0">
                                  ...
                                  <?php if(!empty($busca)): ?>
                                      <a href="analisevaga.php" class="btn btn-sm btn-outline-secondary ml-1" title="Limpar"><i class="fas fa-times"></i></a>
                                  <?php endif; ?>
                              </th>
                            </tr>
                          </thead>
                        ...
                        if ($stmt->rowCount() > 0) {
                            ...
                            <tr>
                                <td class="align-middle pl-4 py-2">
                                    <a href="aprovacaovaga.php?id=<?php echo $id_vaga; ?>" class="text-dark" style="text-decoration: none;">
                                        <?php echo $titulo; ?>
                                    </a> 
                                    <span class="badge badge-warning ml-2" style="font-weight:normal;" title="Empresa"><?php echo $empresa; ?></span>
                                </td>
                                <td class="align-middle text-right pr-4 py-2">
                                    <a href="aprovacaovaga.php?id=<?php echo $id_vaga; ?>" class="table-action-icon text-primary mr-3" title="Aprovar / Editar"><i class="fas fa-pencil-alt"></i></a>
                            ...
                            <tr><td colspan="2" class="text-center text-muted py-5">Nenhuma vaga pendente encontrada.</td></tr>
                        <?php } ?>
                      </tbody>
                    </table>
                </div>
